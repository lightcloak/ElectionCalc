        ...
        private void castVote(string person)
        {
            ...
            using (var db = new LiteDatabase(ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString))
            {
                ...
                using (var trans = db.BeginTrans())
                {
                    ...
                    {
                        Name = name, Surname = surname, Party = party, VotingCitizen = WorkWindow.loggedPerson.Pesel
                    });
                ...
                using (var trans = db.BeginTrans())
                {
                    ...
                    {
                        Name = WorkWindow.loggedPerson.Name, Surname = WorkWindow.loggedPerson.Surname, Pesel = WorkWindow.loggedPerson.Pesel
                    });
